...
Работающий MCP-сервер также проверяет выпуск при первом вызове инструмента после десяти минут без вызовов. Если доступна новая версия, в ответ инструмента добавляется уведомление с установленной и доступной версиями. Сервер никогда не устанавливает выпуск автоматически, а ошибка проверки не прерывает вызов инструмента Beget.
